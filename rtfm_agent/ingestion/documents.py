"""Load and parse documentation .asc/.md files."""

from pathlib import Path

# File extensions treated as documentation sources. Web-crawl pages are
# persisted as markdown (.md) and merged into the same corpus.
